...
var str="<table class='t1'><tr><th>Galer&iacute;a</th><th>Categor&iacute;a<th>Ver</th></tr>";
//var str="<table class='t1'><tr><th>ID</th><th>Gallery</th><th>Visit</th></tr>";
for(i=0;i<myObject.data.length;i++)
{ 
var m=i%2;

str = str + "<tr class='r"+m+ "'><td>" + myObject.data[i].gallery + "("+ myObject.data[i].no + ") </td><td> " + myObject.data[i].categoria + "</td><td><a href=gallery-photo.php?gal_id=" + myObject.data[i].gal_id +  ">Visit</a> </td></tr>"
